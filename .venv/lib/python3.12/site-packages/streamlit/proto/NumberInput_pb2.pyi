...
class NumberInput(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["data_type", b"data_type", "default", b"default", "disabled", b"disabled", "form_id", b"form_id", "format", b"format", "has_max", b"has_max", "has_min", b"has_min", "help", b"help", "id", b"id", "label", b"label", "label_visibility", b"label_visibility", "max", b"max", "min", b"min", "set_value", b"set_value", "step", b"step", "value", b"value"]) -> None: ...
